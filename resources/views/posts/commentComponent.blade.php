...
@endif
    <a href="/profile/{{ $comment->commenter->id }}"><img class="mr-3" src="{{ $comment->commenter->profile->profileImage() }}" class="w-50 rounded-circle" style="max-width: 50px;"></a>
    <div class="media-body">
        <h5 class="mt-0 mb-1"><a href="/profile/{{ $comment->commenter->id }}"><div class="text-dark">{{ $comment->commenter->name ?? $comment->guest_name }}</div></a> <small class="text-muted">- {{ $comment->created_at->diffForHumans() }}</small></h5>
